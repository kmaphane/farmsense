...
return [
     ...
     */
    'structure_caching' => [
        'enabled' => env('DATA_STRUCTURE_CACHING', true),
        'directories' => [
            app_path('Data'),
            base_path('domains/Auth/DTOs'),
            base_path('domains/Broiler/DTOs'),
            base_path('domains/CRM/DTOs'),
            base_path('domains/Finance/DTOs'),
            base_path('domains/Inventory/DTOs'),
            base_path('domains/IoT/DTOs'),
            base_path('domains/Shared/DTOs'),
        ],
        'cache' => [
