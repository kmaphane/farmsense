...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        // Use the .text-brand-yellow utility for headings
        "text-brand-green font-bold uppercase tracking-wider flex h-8 shrink-0 items-center rounded-md px-2 text-xs mt-2 mb-1 outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
