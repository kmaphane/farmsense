import {
    store,
    update,
} from '@/actions/App/Http/Controllers/Batches/DailyLogController';
                ...
                <div className={compact ? 'space-y-4' : 'space-y-6'}>
                    ...
                    {lastLog && !isEdit && !compact && (
                        <Card className="border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-950/30">
                            ...
                            <CardContent>
                                <div className="grid grid-cols-2 gap-2 text-sm text-blue-700 sm:grid-cols-4 dark:text-blue-300">
                                    <div>
                                        Mortality: {lastLog.mortality_count}
                                    </div>
                                    <div>
                                        Feed: {lastLog.feed_consumed_kg}kg
                                    </div>
                                    {lastLog.temperature_celsius && (
                                        <div>
                                            Temp: {lastLog.temperature_celsius}
                                            °C
                                        </div>
                                    )}
                                    {lastLog.humidity_percent && (
                                        <div>
                                            Humidity: {lastLog.humidity_percent}
                                            %
                                        </div>
                                    )}
                                </div>
                        ...
                        <Card className="border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950/30">
                            <CardHeader className="pb-2">
                                ...
                                <CardDescription className="text-amber-700 dark:text-amber-300">
                                    You can only edit logs from today. After
                                    midnight, logs become read-only.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                    )}
                    ...
                    {compact ? (
                        <div className="space-y-4">
                            <FormField
                                ...
                                required
                                defaultValue={
                                    dailyLog?.log_date ?? suggestedDate
                                }
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    name="notes"
                                    rows={2}
                                    className="flex min-h-[60px] w-full rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-xs placeholder:text-gray-400 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-800"
                        ...
                        <>
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        {isEdit ? 'Update' : 'Record'} daily
                                        batch data. Required fields are marked
                                        with *.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    ...
                                    <FormField
                                        ...
                                        step="0.01"
                                        defaultValue={
                                            dailyLog?.water_consumed_liters
                                        }
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Optional environmental readings from the
                                        house
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                ...
                                <CardContent>
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            name="notes"
                                            rows={3}
                                            className="flex min-h-[80px] w-full rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-xs placeholder:text-gray-400 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-800"
